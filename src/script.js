...
// Geometry
const partilclesUvArray=new Float32Array(baseGeometry.count*2)
...
for(let y=0;y<gpgpu.size;y++){
    for(let x=0;x<gpgpu.size;x++){
        ...
        partilclesUvArray[i2+0]=uvX
        partilclesUvArray[i2+1]=uvY
...
particles.geometry.setAttribute("aParticlesUv",new THREE.BufferAttribute(partilclesUvArray,2))
